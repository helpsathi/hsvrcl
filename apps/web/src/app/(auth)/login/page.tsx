...
function LoginContent() {
  ...
  const googleLogin = useGoogleLogin({
    ...
    onError: () => {
      setError(
        <span>
          Google Login failed. Please ensure popups are allowed, or <a href="https://accounts.google.com/Login" target="_blank" rel="noopener noreferrer" className="underline font-bold text-rose-800 dark:text-rose-200">sign into your Google account</a> first.
        </span>
      );
      setLoading(false);
    }
        ...
        <div className="w-full space-y-4">
          {loading ? (
            ...
            >
              ...
              <span className="font-bold text-slate-700 dark:text-white text-[15px]">Sign in with Google</span>
            </button>
          )}
          
          <div className="text-center pt-2">
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
              Not logged into Google? <a href="https://accounts.google.com/Login" target="_blank" rel="noopener noreferrer" className="text-emerald-600 dark:text-emerald-400 font-bold hover:underline">Click here to sign in</a> first, then return to continue.
            </p>
          </div>
