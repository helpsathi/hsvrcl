...
import { X, ArrowLineDown, Lightning, Bell, ShieldCheck, ShareNetwork, PlusSquare } from "@phosphor-icons/react";
      ...
      <div className="pointer-events-auto bg-white/95 dark:bg-slate-900/95 text-slate-900 dark:text-white backdrop-blur-2xl border border-slate-200/80 dark:border-slate-800 shadow-2xl rounded-3xl p-4 sm:p-5 relative overflow-hidden transition-all">
        ...
        <div className="grid grid-cols-3 gap-1.5 my-3 pt-3 border-t border-slate-100 dark:border-slate-800 text-[10px] sm:text-[11px] text-slate-700 dark:text-slate-300 font-bold">
          <div className="flex items-center gap-1">
            <Lightning weight="fill" className="w-3.5 h-3.5 text-amber-500 shrink-0" />
            <span className="truncate">Offline Access</span>
          </div>
          <div className="flex items-center gap-1">
            <Bell weight="fill" className="w-3.5 h-3.5 text-brand-main shrink-0" />
            <span className="truncate">Instant Alerts</span>
          </div>
          <div className="flex items-center gap-1">
            <ShieldCheck weight="fill" className="w-3.5 h-3.5 text-blue-500 shrink-0" />
        ...
        {isIOS ? (
          <div className="bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 rounded-2xl p-3 text-[11px] text-slate-700 dark:text-slate-200">
            ...
            <ol className="mt-1.5 space-y-1 text-slate-600 dark:text-slate-300 list-decimal list-inside font-medium">
              <li>
                Tap <span className="inline-flex items-center font-bold text-slate-900 dark:text-white"><ShareNetwork className="inline mx-0.5" /> Share</span> in Safari menu.
              </li>
              <li>
                Select <span className="inline-flex items-center font-bold text-slate-900 dark:text-white"><PlusSquare className="inline mx-0.5 text-emerald-500" /> Add to Home Screen</span>.
              </li>
            </ol>
            <button
              onClick={handleAddLater}
          ...
          <div className="flex items-center gap-2 pt-0.5">
            <button
              ...
              className="flex-1 py-2.5 px-4 bg-slate-900 hover:bg-slate-800 dark:bg-brand-main dark:hover:bg-brand-main/90 active:scale-[0.98] text-white font-extrabold text-xs rounded-xl shadow-md transition-all flex items-center justify-center gap-1.5"
            >
              <ArrowLineDown weight="bold" className="w-4 h-4" />
